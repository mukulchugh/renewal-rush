#!/usr/bin/env python3
"""Run Renewal Rush 3D arena setup via Unreal MCP."""
...
from setup_3d_renewal_rush_script import SETUP_3D_SCRIPT
...
def main() -> int:
    ...
    print("Running Renewal Rush 3D setup...")
    result = client.execute_tool_script(SETUP_3D_SCRIPT, timeout=600)
    print(result)
    ...
    try:
        ...
        out = Path(__file__).parent.parent / "assets" / "arena-3d-setup-capture.txt"
